...
| 항목 | 결과 |
|---|:--:|
| 자동 테스트 (pytest) | ✅ **128 passed, 1 skipped** <br/>_(2026-08-13 실행 기준 · 현재 194개 → [PROGRESS.md](PROGRESS.md))_ |
...
연속 호출 시 Exa 가 `429 rate limit (10 req/s)` 를 반환한다. Tavily 폴백이
받아 주지만 근거 품질이 떨어진다. 자동 테스트를 연속으로 돌릴 때 재현된다.
